...
echo.
echo === Clean ===
dotnet clean Icod.CommandFramework.sln -c Debug
exit /b %errorlevel%
...
echo.
echo === Build ===
dotnet build Icod.CommandFramework.sln -c Debug --no-restore
exit /b %errorlevel%
...
echo.
echo === Test ===
dotnet test Icod.CommandFramework.sln -c Debug --no-build
exit /b %errorlevel%

:pack
echo.
echo === Pack ===
dotnet pack Icod.CommandFramework.sln -c Debug --include-source --include-symbols --no-build
exit /b %errorlevel%
