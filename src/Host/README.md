...
`Icod.CommandFramework.Host` is the Completion Gate F2 factual provider layer. It is provisionally classified as an `Icod.CommandFramework` candidate because Coreutils and the later ProcPs family consume the same host and processor facts.
