...
`Icod.CommandFramework.FileSystem.Metadata` is the Completion Gate E3 authority for filesystem metadata and timestamp mutation. It enriches the stable entry and filesystem identities introduced by Completion Gate E1 rather than creating a second identity model.
