...
`Icod.CommandFramework.FileSystem.Traversal` is the Completion Gate E1 read-only pathname foundation. It separates three responsibilities that command projects must not reimplement independently:
