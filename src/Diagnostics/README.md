...
The `Icod.CommandFramework.Diagnostics` namespace defines the common execution context, exit statuses, command result, and diagnostic writer used by command implementations.
